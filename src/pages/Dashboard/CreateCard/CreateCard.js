...
const CreateCard = ({setSubmissionSuccess}) => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      setProfilePictureLabel('Background Image');
    }
  };
        ...
        {currentStep === 2 && (
          ...
          <div className="social-input-container">
            <div className="social-input">
              <img src="https://cdn.shopify.com/s/files/1/0733/7767/7577/files/icons8-instagram.svg?v=1712083465" className='social'/>
              <input
                type="text"
                name="instagram"
            ...
            <div className="social-input">
              <img src='https://cdn.shopify.com/s/files/1/0733/7767/7577/files/icons8-facebook.svg?v=1712083465' className='social'/>
              <input
                type="text"
                name="facebook"
            ...
            <div className="social-input">
              <img src='https://cdn.shopify.com/s/files/1/0733/7767/7577/files/icons8-linkedin.svg?v=1712083465' className='social'/>
              <input
                type="text"
                name="linkedin"
            ...
            <div className="social-input">
              <img src='https://cdn.shopify.com/s/files/1/0733/7767/7577/files/url.png?v=1712083467' className='social'/>
              <input
                type="text"
                name="url"
                placeholder="Url"
